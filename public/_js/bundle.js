...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collisionDetector = __webpack_require__(7);
	
	var _collisionDetector2 = _interopRequireDefault(_collisionDetector);
	
	var _jqueryKaboom = __webpack_require__(8);
	
	var _jqueryKaboom2 = _interopRequireDefault(_jqueryKaboom);
	...
	_BubbleShoot2.default.Renderer = _renderer2.default;
	_BubbleShoot2.default.Sprite = _sprite2.default;
	
	_BubbleShoot2.default.CollisionDetector = _collisionDetector2.default;
	
	//BubbleShoot.Game is an IIFE that returns a constructor Object.
	_BubbleShoot2.default.Game = function ($) {
	    var Game = function Game() {
	
	        var curBubble = void 0,
	            board = void 0,
	            numBubbles = void 0,
	            coords = void 0,
	            bubbles = [],
	        ...
	        this.init = function () {
	            ...
	            if (_BubbleShoot2.default.Renderer) {
	                _BubbleShoot2.default.Renderer.init(function () {
	        ...
	        var getNextBubble = function getNextBubble() {
	            ...
	            var bubble = _BubbleShoot2.default.Bubble.createBubble();
	            bubbles.push(bubble);
	            bubble.setState(_BubbleShoot2.default.BubbleState.CURRENT);
	            bubble.getSprite().addClass('cur_bubble');
	
	            var top = 470,
	                left = ($('#board').width() - _BubbleShoot2.default.ui.BUBBLE_DIMS) / 2;
	            ...
	            _BubbleShoot2.default.ui.drawBubblesRemaining(numBubbles);
	            numBubbles -= 1;
	            return bubble;
	        };
	        ...
	        var clickGameScreen = function clickGameScreen(e) {
	            ...
	            if (collision) {
	                ...
	                var distX = Math.sin(angle) * distance,
	                    ...
	                    bubbleCoords = _BubbleShoot2.default.ui.getBubbleCoords(curBubble.getSprite());
	                coords = {
	        ...
	        var dropBubbles = function dropBubbles(bubbles, delay) {
	            $.each(bubbles, function () {
	                ...
	                setTimeout(function () {
	                    bubble.setState(_BubbleShoot2.default.BubbleState.FALLING);
	        ...
	        var popBubbles = function popBubbles(bubbles, delay) {
	            $.each(bubbles, function () {
	                var bubble = this;
	                setTimeout(function () {
	                    bubble.setState(_BubbleShoot2.default.BubbleState.POPPING);
	                    bubble.animatePop();
	                    setTimeout(function () {
	...
	(0, _jquery2.default)(function () {
	    var game = new _BubbleShoot2.default.Game();
	    game.init();
	});
	...
	var ui = function ($) {
	    var ui = {
	        ...
	        fireBubble: function fireBubble(bubble, coords, duration) {
	            ...
	            bubble.setState(_BubbleShoot2.default.BubbleState.FIRING);
	            ...
	            var complete = function complete() {
	                if (bubble.getRow() !== null) {
	                    ...
	                    bubble.setState(_BubbleShoot2.default.BubbleState.ON_BOARD);
	                } else {
	                    bubble.setState(_BubbleShoot2.default.BubbleState.FIRED);
	                }
	            };
	        ...
	        drawBubblesRemaining: function drawBubblesRemaining(numBubbles) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bubble = function ($) {
	    ...
	    _BubbleShoot2.default.BubbleState = {
	        CURRENT: 1,
	        ON_BOARD: 2,
	        FIRING: 3,
	        POPPING: 4,
	    ...
	    var Bubble = function Bubble(row, col, type, sprite) {
	        ...
	        this.getCoords = function () {
	            var coords = {
	                left: that.getCol() * _BubbleShoot2.default.ui.BUBBLE_DIMS / 2 + _BubbleShoot2.default.ui.BUBBLE_DIMS / 2,
	                top: that.getRow() * _BubbleShoot2.default.ui.ROW_HEIGHT + _BubbleShoot2.default.ui.BUBBLE_DIMS / 2
	            };
	            return coords;
	        };
	    ...
	    Bubble.createBubble = function (rowNum, colNum, type) {
	        ...
	        if (!_BubbleShoot2.default.Renderer) {
	            ...
	            sprite = new _BubbleShoot2.default.Sprite();
	        }
	...
	var Board = function ($) {
	    ...
	    var Board = function Board() {
	        ...
	        this.addBubble = function (bubble, coords) {
	            var rowNum = Math.floor(coords.y / _BubbleShoot2.default.ui.ROW_HEIGHT),
	                colNum = coords.x / _BubbleShoot2.default.ui.BUBBLE_DIMS * 2;
	        ...
	        this.findOrphans = function () {
	            ...
	            for (e = 0; e < rows.length; e += 1) {
	                for (j = 0; j < rows[e].length; j += 1) {
	                    var _bubble = that.getBubbleAt(e, j);
	                    if (_bubble && !connected[e][j]) {
	                        orphaned.push(_bubble);
	                    }
	                }
	            }
	    ...
	    var createLayout = function createLayout() {
	        ...
	        for (i = 0; i < NUM_ROWS; i += 1) {
	            ...
	            for (j = startCol; j < NUM_COLS; j += 2) {
	                var bubble = _BubbleShoot2.default.Bubble.createBubble(i, j);
	                bubble.setState(_BubbleShoot2.default.BubbleState.ON_BOARD);
	                if (_BubbleShoot2.default.Renderer) {
	                    var left = j * _BubbleShoot2.default.ui.BUBBLE_DIMS / 2,
	                        top = i * _BubbleShoot2.default.ui.ROW_HEIGHT;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CollisionDetector = function ($) {
	    var CollisionDetector = {
	        findIntersection: function findIntersection(curBubble, board, angle) {
	            var rows = board.getRows(),
	                pos = curBubble.getSprite().position(),
	                start = {
	                left: pos.left + _BubbleShoot2.default.ui.BUBBLE_DIMS / 2,
	                top: pos.top + _BubbleShoot2.default.ui.BUBBLE_DIMS / 2
	            },
	                dx = Math.sin(angle),
	                dy = -Math.cos(angle);
	
	            var collision = null;
	            var distToCollision = void 0;
	            var dest = void 0;
	            ...
	            rows.forEach(function (row, i) {
	                row.forEach(function (bubble, j) {
	                    if (bubble) {
	                        ...
	                        if (distEC < _BubbleShoot2.default.ui.BUBBLE_DIMS * 0.75) {
	                            var dt = Math.sqrt(_BubbleShoot2.default.ui.BUBBLE_DIMS * _BubbleShoot2.default.ui.BUBBLE_DIMS - distEC * distEC),
	                                offset1 = {
	                                x: (t - dt) * dx,
	                                y: -(t - dt) * dy
	                            },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Renderer = function ($) {
	    ...
	    var Renderer = {
	            ...
	            $.each(bubbles, function () {
	                ...
	                switch (bubble.getState()) {
	                    case _BubbleShoot2.default.BubbleState.POPPING:
	                        ...
	                        break;
	                    case _BubbleShoot2.default.BubbleState.POPPED:
	                        return;
	        ...
	        drawSprite: function drawSprite(sprite, clip) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sprite = function ($) {
	    ...
	    Sprite.prototype.width = function () {
	        return _BubbleShoot2.default.ui.BUBBLE_DIMS;
	    };
	    ...
	    Sprite.prototype.kaboom = function () {
	        _jquery2.default.fn.kaboom.apply(this);
	    };
	    return Sprite;
	}(_jquery2.default);
