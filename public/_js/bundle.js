...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bubble = __webpack_require__(4);
	...
	var _collisionDetector = __webpack_require__(6);

	var _collisionDetector2 = _interopRequireDefault(_collisionDetector);

	var _jqueryKaboom = __webpack_require__(7);
	...
	BubbleShoot.ui = _ui2.default;
	//BubbleShoot.Bubble returns a constructor Object
	BubbleShoot.Bubble = _bubble2.default;
	BubbleShoot.Board = _board2.default;
	BubbleShoot.CollisionDetector = _collisionDetector2.default;
	...
	BubbleShoot.Game = function ($) {
	    var Game = function Game() {
	        ...
	        var getNextBubble = function getNextBubble() {
	            ...
	            var bubble = BubbleShoot.Bubble.createBubble();
	...
	var Bubble = function ($) {
	    ...
	    var Bubble = function Bubble(row, col, type, sprite) {
	        ...
	        this.getCoords = function () {
	            var coords = {
	                left: that.getCol() * _game2.default.ui.BUBBLE_DIMS / 2 + _game2.default.ui.BUBBLE_DIMS / 2,
	                top: that.getRow() * _game2.default.ui.ROW_HEIGHT + _game2.default.ui.BUBBLE_DIMS / 2
	            };
	            return coords;
	        };
	...
	var Board = function ($) {
	    ...
	    var Board = function Board() {
	        ...
	        this.addBubble = function (bubble, coords) {
	            var rowNum = Math.floor(coords.y / _game2.default.ui.ROW_HEIGHT),
	                colNum = coords.x / _game2.default.ui.BUBBLE_DIMS * 2;
	    ...
	    var createLayout = function createLayout() {
	        ...
	        for (i = 0; i < NUM_ROWS; i += 1) {
	            ...
	            for (j = startCol; j < NUM_COLS; j += 2) {
	                var bubble = _game2.default.Bubble.createBubble(i, j);
	                row[j] = bubble;
	            }
	            rows.push(row);
	        }
	    ...
	    var CollisionDetector = {
	        findIntersection: function findIntersection(curBubble, board, angle) {
	            var rows = board.getRows(),
	                ...
	                start = {
	                left: pos.left + _game2.default.ui.BUBBLE_DIMS / 2,
	                top: pos.top + _game2.default.ui.BUBBLE_DIMS / 2
	            },
	                dx = Math.sin(angle),
	                dy = -Math.cos(angle);
	            ...
	            rows.forEach(function (row, i) {
	                row.forEach(function (bubble, j) {
	                    if (bubble) {
	                        ...
	                        if (distEC < _game2.default.ui.BUBBLE_DIMS * 0.75) {
	                            var dt = Math.sqrt(_game2.default.ui.BUBBLE_DIMS * _game2.default.ui.BUBBLE_DIMS - distEC * distEC),
	                                offset1 = {
	                                x: (t - dt) * dx,
	                                y: -(t - dt) * dy
	                            },
